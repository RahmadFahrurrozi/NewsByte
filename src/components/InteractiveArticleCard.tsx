...
import { SparklesIcon, Share2, BookOpenText } from "lucide-react";
    ...
    >
      ...
      <div className="absolute bottom-10 flex w-full flex-col items-center">
        ...
        <div className="absolute -top-3 z-20 flex items-center justify-center rounded-lg border bg-background px-2 py-1 sm:-top-4 sm:py-1.5">
          ...
          <span className="ml-2 text-[10px] text-foreground sm:text-xs">
            {title ? title : "Data exchange using a customized REST API"}
          </span>
        </div>
        {/* box outter circle */}
        <div className="absolute -bottom-8 z-30 grid h-[60px] w-[60px] place-items-center rounded-full border-t bg-background font-semibold text-xs text-foreground shadow-md">
        ...
        <div className="relative z-10 flex h-[150px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background shadow-md">
          {/* Badges */}
          <div className="absolute bottom-8 left-12 z-10 h-7 rounded-full bg-background px-3 text-xs border flex items-center gap-2 ">
            <BookOpenText className="size-4" />
            <span>{buttonTexts?.first || "LegionDev"}</span>
          </div>
          <div className="absolute right-16 z-10 hidden h-7 rounded-full bg-background px-3 text-xs sm:flex border items-center gap-2">
