...
import { Calendar, Edit2Icon, LucideIcon } from "lucide-react";
        ...
        <div className="mx-auto grid gap-4 lg:grid-cols-2">
          <FeatureCard>
            <CardHeader className="pb-3">
              <CardHeading
                ...
                description="Powerful editor for seamless writing and publishing."
              />
            </CardHeader>
            ...
            <div className="relative mb-6 border-t border-dashed sm:mb-0">
              ...
              <div className="aspect-[76/59] p-1 px-6">
                <InteractiveArticleCard
                  title="Explre our trending articles"
                  badgeTexts={{
                    first: "Trending",
                    second: "Latest",
                    third: "Popular",
          ...
          <FeatureCard>
            <CardHeader className="pb-3">
              <CardHeading
                icon={Calendar}
                title="Smart Publishing Schedule"
                description="Plan and schedule your articles for perfect timing."
              />
            </CardHeader>
          ...
          <FeatureCard className="p-6 lg:col-span-2">
            <p className="mx-auto my-6 max-w-md text-balance text-center text-2xl font-semibold">
              Drive engagement with a vibrant community.
            </p>
